...
// data database (specification section 10). It owns connection injection, DDL
// and grant reconcile, drift, and the journal and its triggers; two clients, two
// databases, never crossed (store owns meta, pg owns data).
//
...
// (S16/integration-fakes-interfaces). A golden diff is a contract diff.
package pg
