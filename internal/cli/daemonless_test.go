...
// install`, `engine service uninstall`, `engine uninstall`, and the root verbs
// `iris update` (self-replace of the binary) and `iris uninstall` (self-removal
// of the binary) are classified runnable
