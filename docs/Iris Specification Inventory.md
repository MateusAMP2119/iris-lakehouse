...
# uninstall - the sole root lifecycle verb: remove the iris binary itself (daemonless self-removal; distinct from engine uninstall, which tears down engine state)
